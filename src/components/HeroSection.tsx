...
const HeroSection: React.FC = () => {
  const appSubdomain = process.env.REACT_APP_APP_SUBDOMAIN || 'app.goldleafsmsrecovery.com';
  ...
  return (
    <HeroContainer>
      <HeroContent>
        ...
        <Tagline>We specialize in serving merchants who acquire customers through <strong style={{color: '#A78BFA'}}>SMS campaigns</strong>. Our decline recovery technology is optimized for businesses using text message marketing, mobile-based offers, and SMS-initiated purchase flows.</Tagline>
        <CTAButtonGroup>
