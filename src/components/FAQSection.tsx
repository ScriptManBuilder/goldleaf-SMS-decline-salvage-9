...
const FAQSection: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Merchants acquiring customers through SMS campaigns, text message marketing, and mobile-based customer acquisition. We specialize in recovering failed payments from SMS-initiated transactions and text-based purchase flows.'
    },
    {
